...
public class Main_stringbuilder {
	...
	public static void main(String[] args) {
		...
		String name = "일순신";    // 메모리상에  name 1개 소모
         ...
         System.out.println(sb_1); //생략해도 같은 값나옴
         ...
         str = sb_3.reverse().toString(); //거꾸로 되어진걸 스트링타입으로 바꿈
         System.out.println(str);
         //요세하녕안
         
         str = "안녕하세요";
         StringBuilder sb_4 = new StringBuilder(str);
         str = sb_4.reverse().toString(); //거꾸로 되어진걸 스트링타입으로 바꿈
         System.out.println(str);
         //요세하녕안
