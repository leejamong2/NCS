...
public class Main_calendar {
	...
	public static void main(String[] args) {
		...
		//>> 현재시각 1 => Tue Jan 30 12:27:34 GMT+09:00 2024
		
		SimpleDateFormat sdformat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		
		System.out.println(">> 현재시각 2 => " + sdformat.format(now));
		//>> 현재시각 2 => 2024-01-30 12:29:18
		 ...
		 */
		String currentTime = String.format("%tF %tp %tT %tA %tZ",now, now, now, now, now); // %t  시간
		System.out.println(">> 현재시각 3 => " + currentTime);
		//>> 현재시각 3 => 2024-01-30 오후 12:34:36 화요일 GMT+09:00
	...
	System.out.println("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");   
		 ...
		 */   
		Calendar currentDate = Calendar.getInstance(); //date는 뉴로 했는데 캘린더는 스태틱
		// 현재날짜와 시간을 얻어온다.
	
		int year = currentDate.get(Calendar.YEAR);
	
		int month = currentDate.get(Calendar.MONTH); // 0 ~ 11 이기때문에 반드시 +1해줘여함 

	
		String strMonth = month<10? "0"+month : String.valueOf(month);  //month가 인트타입이니까 스트링으로 변환해줌
		/* 
	   ...
	   */
	    ...
	    System.out.println("월(0~12, 1:1월): " + strMonth);
	 ...
	 // 1:일요일, 2:월요일, 3:화요일, 4:수요일, 5:목요일, 6:금요일, 7:토요일
	    ...
	    System.out.println("이 달의 몇 째 주 요일: " + currentDate.get(Calendar.DAY_OF_WEEK_IN_MONTH));
	 ...
	 // 천분의 1초를 시간으로 표시하기 위해 3600000으로 나누었다.(1시간 = 60 * 60초)
	    ...
	    // 현재시각 => 2023-07-03 10:56:31
	     ...
	     currentDate.add(Calendar.SECOND, 4);
