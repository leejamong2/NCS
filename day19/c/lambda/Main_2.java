...
public class Main_2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("=== 람다식(Lamda)을 사용하지 않은 것[무명(익명)클래스를 사용한 것]");
		...
		//가로 10.5세로5.5인 사각형 면적은 : 57.75
		
		area_obj.area(10.5, 5.5, 2);
		//밑변 10.5높이5.5인 삼각형 면적은 : 28.875
		
		area_obj.area(10.5, 5.5, 3);
		//장축의 반지름 10.5단축의 반지름5.5인 타원형 면적은 : 181.426938
	   ...
	   */
		...
		//3.실행명령문이 한개라면 { }; 를 생략할 수 있다.
		Functional_Search_4 lamda_srch = (str) ->  System.out.println("회원들 중 \"" +str+"\" 님을 조회합니다");
		lamda_srch.search("이순신");
		
		//4.파라미터의 개수가 1개일 때는 파라미터를 감싸는 소괄호( )를 생략할 수 있다
		Functional_Search_4 lamda_srch2 = str ->  System.out.println("회원들 중 \'" +str+"\' 님을 조회합니다");
		lamda_srch2.search("엄정화");
		
		
		
	/*	// 5. 파리미터의 개수가 2개 이상일 때는 무조건 소괄호 ()를 꼭 기재해야 한다.
	...
	*/
		...
		Functional_Search_5 lambda_srch3 = () -> {
			...
			System.out.println("=== 모든 회원 조회 결과 ===");  //명령어 복수개라 중괄호 빼면 안됨
		};
		...
		// 7. 실행명령문이 1개 이더라도 return 이 있을 경우에는 반드시 { }; 을 써야하고 생략할 수 없다.
		...
		//8. return  문만 있는 단일코드인 경우에는 { }; 및 return 을 생략할 수 있다.
