	...
	public static void main(String[] args) {
	      ...
	      try {
	         ...
	         */
		      ...
		      cstmt.registerOutParameter(3, java.sql.Types.VARCHAR);	// 숫자 3는 프로시저 파라미터중 두번째 파라미터인 OUT 모드의 ? 를 말한다.
		      cstmt.registerOutParameter(4, java.sql.Types.VARCHAR);	// 숫자 4는 프로시저 파라미터중 두번째 파라미터인 OUT 모드의 ? 를 말한다.
		      cstmt.registerOutParameter(5, java.sql.Types.VARCHAR);	// 숫자 5는 프로시저 파라미터중 두번째 파라미터인 OUT 모드의 ? 를 말한다.
		      cstmt.registerOutParameter(6, java.sql.Types.VARCHAR);	// 숫자 6는 프로시저 파라미터중 두번째 파라미터인 OUT 모드의 ? 를 말한다.
		      cstmt.registerOutParameter(7, java.sql.Types.VARCHAR);	// 숫자 7는 프로시저 파라미터중 두번째 파라미터인 OUT 모드의 ? 를 말한다.
		      ...
		      if(cstmt.getString(2) == null) { //두번쩨컬럼가 널이냐
		    	  System.out.println(">>입력하신 "+stno+"학번은 존재하지 않습니다<<");
		      }
		      else {
