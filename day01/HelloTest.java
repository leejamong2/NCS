/*
 ...
 자바(JAVA)라는 프로그램 개발언어를 사용하여 만드는 설계도면 "클래스"라고 한다.
 
 ====****CLASS(클래스)의 구조 ****====
   1. 패키지 선언문
     ==> 패키지란 클래스가 저장되어진 디렉토리(폴더) 경로러고 보면 된다.
   ...
   4.컴파일(compile)하기
     ...
     javac 를 사용하여 컴파일을 하면 .java 파일이 .class 로 생성이 된다.
...
public class HelloTest {
	...
	// 또한 저장시 파일명은 클래스명과 동일하게 해야 하며, 확장자는 .java 이다.
	...
	public static void main(String[] args) {
		...
		/**
		   문서화 주석
		   ==> 어떤 클래스나 어떤 메소드 생성시 javadoc를 이용해서 API문서를 만들 때 사용한다.
		 */



		// System.out은 모니터라고 보면 된다.
		...
		/*
		 System.out.print("출력하고자 하는 문자열"); 은 모니터에 "출력하고자 하는 문자열" 을 출력해라는 말이다.
		 */
		...
		Date now = new Date(); // new Date();은 컴퓨터의 현재시간
		System.out.println("컴퓨터에서 알려주는 현재시각 : " + now);
		////new Date();를 now에 넣어주기
