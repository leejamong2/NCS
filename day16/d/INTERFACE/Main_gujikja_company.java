...
public class Main_gujikja_company {
	...
	public static void main(String[] args) {
		...
		rc_arr[Recruit_imple.count++] = rc1;  			// 모집공고 모을겨
		...
		rc_arr[Recruit_imple.count++] = rc2;  			// 모집공고 모을겨
		...
		rc_arr[Recruit_imple.count++] = rc3;  			// 모집공고 모을겨
		...
		do {//4번 할때까지 돌거야
			...
			case "3":   //구직자 로그인
				...
				if(login_gu != null) {
					...
					ctrl_gu.gu_menu(sc, (Gujikja_imple)login_gu, cmbr_arr, rc_arr, rcApply_arr);
				}
				else {
			...
			case "4" :	//구인회사 로그인
				...
				if(login_cp != null) {
					...
					ctrl_cp.cp_menu(sc, (Company_imple)login_cp, cmbr_arr, rc_arr, rcApply_arr);  //구인회사 전용메뉴 , 모집공고저장소
				}
				else {
