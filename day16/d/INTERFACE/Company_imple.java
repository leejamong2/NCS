...
public class Company_imple extends CommonMember implements Company{  //상속되어진 부모클래스에 있는 겟인포라는 미완성 메소드는 오버라이딩 해야한다.  컴패니와 커먼멤버 둘다 동일하게 겟인포를 중복으로가리키고있음 오버라이딩을 두번해야하니까 덜중요한 컴패니의 커먼연결을 지우고 더 중요한  커먼멤버의 겟인포를 가져옴
